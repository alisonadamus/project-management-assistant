<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
            {{ __('Дозволена авторизація лише з доменами @student.uzhnu.edu.ua або @uzhnu.edu.ua') }}
        </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">{{ __('Або увійти через') }}</p>
