    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6">
                <!-- Фільтри та пошук -->
                <div class="mb-6">
                    <form action="{{ route('events.archived') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                ...
                @if($events->isEmpty())
                    <div class="text-center py-12">
                        ...
                        <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">Архівованих подій не знайдено</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Наразі немає архівованих подій. Перегляньте активні або майбутні події.</p>
                    </div>
                @else
